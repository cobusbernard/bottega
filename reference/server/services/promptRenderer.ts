...
const PROMPT_DEFINITIONS: PromptDefinition[] = [
  ...
  },
  {
    ...
    kind: 'prompt',
    file: 'pr.md',
    variables: ['taskDocPath', 'taskId', 'prContextLine', 'prCreateOrVerifyBlock', 'forgeCli', 'ciLogHint'],
  },
  {
    name: 'yolo',
    label: 'YOLO Agent',
  ...
  },
  {
    ...
    kind: 'prompt',
    file: 'pr-feedback.md',
    variables: ['taskDocPath', 'taskId', 'prUrl', 'feedbackSection', 'forgeCli', 'ciLogHint'],
  },
  {
    name: 'plan-template',
    label: 'Plan Template',
